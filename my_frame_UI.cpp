...
{
	this->SetSizeHints( wxSize( 900,670 ), wxDefaultSize );
	...
	mainSizer->SetMinSize( wxSize( 890,670 ) );
	wxGridBagSizer* controlSizer;
	controlSizer = new wxGridBagSizer( 0, 0 );
	controlSizer->SetFlexibleDirection( wxVERTICAL );
	controlSizer->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );

	controlSizer->SetMinSize( wxSize( 270,620 ) );
	controlPanel = new wxPanel( this, wxID_ANY, wxDefaultPosition, wxSize( 270,620 ), wxTAB_TRAVERSAL );
	controlPanel->SetMinSize( wxSize( 270,620 ) );
	...
	wxGridSizer* gSizer6;
	gSizer6 = new wxGridSizer( 0, 2, 0, 20 );

	m_button_iir_start = new wxButton( controlPanel, wxID_ANY, wxT("START IIR"), wxDefaultPosition, wxSize( 80,30 ), 0 );
	gSizer6->Add( m_button_iir_start, 0, wxALL, 5 );

	m_button_fir_start = new wxButton( controlPanel, wxID_ANY, wxT("START FIR"), wxDefaultPosition, wxSize( 80,30 ), 0 );
	gSizer6->Add( m_button_fir_start, 0, wxALL, 5 );


	gbSizer3->Add( gSizer6, wxGBPosition( 22, 0 ), wxGBSpan( 2, 2 ), wxALIGN_CENTER|wxALL, 5 );
	...
	plotSizer = new wxGridSizer( 2, 1, 0, 0 );

	plotSizer->SetMinSize( wxSize( 500,620 ) );
	...
	plotSizer->Add( filterPanel, 0, wxALL|wxEXPAND, 5 );
	...
	plotSizer->Add( dftPanel, 0, wxALL|wxEXPAND, 5 );


	mainSizer->Add( plotSizer, wxGBPosition( 0, 2 ), wxGBSpan( 4, 6 ), wxALIGN_TOP|wxEXPAND, 5 );
